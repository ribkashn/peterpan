...
@endif
<div class="row">
    <form action="/motor_reg/simpan" method="POST" class="form-horizontal" enctype="multipart/form-data">
    {{csrf_field()}}
        <div class="form-group">
            <div class="box box-default color-palette-box">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-tag"></i> Paket Regular Cuci Motor</h3>
                    </div>
                        <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input type="text" class="form-control" id="id_paket" name="id_paket" value="3" readonly>
                            </div>
                        </div>
                        <div class="form-group">
