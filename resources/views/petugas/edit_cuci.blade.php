...
<div class="container-xl">
    <p><h3>Status Cuci</h3> </p>

</div>
<div class="row">
    <form action="/daftar_cuci/update/{{$data_trans->id_trans}}" method="POST" class="form-horizontal">
    {{csrf_field()}}
        <div class="form-group">
            <div class="box box-default color-palette-box">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-tag"></i> Daftar Cuci Status</h3>
                    </div>
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" class="form-control" id="id_paket" name="id_paket" value="{{ $data_trans->id_paket }}" readonly>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <!--<div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="file" class="form-control" id="bukti_image"name="bukti_image" value="{{ $data_trans->bukti_image }}" readonly>
                                </div> 
                            </div>  -->                   
