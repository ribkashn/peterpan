...
<div class="row">
    <form action="/admin/mobil_reg/simpan" method="POST" class="form-horizontal" enctype="multipart/form-data">
    {{csrf_field()}}
            ...
            <div class="box box-default color-palette-box">
                    <div class="box-header with-border">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input type="text" class="form-control" id="id_paket" name="id_paket" value="1" readonly>
                            </div>
                        </div>
                        <div class="form-group">
