...
<div class="row">
    <form action="/admin/motor_pre/simpan" method="POST" class="form-horizontal">
    {{csrf_field()}}
            ...
            <div class="box box-default color-palette-box">
                    <div class="box-header with-border">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input type="text" class="form-control" id="paket" name="paket" value="Premium Motor" readonly>
                            </div>
                        </div>
                        <div class="form-group">
