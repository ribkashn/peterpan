...
<div class="row">
    <form action="/admin/mobil_pre/simpan" method="POST" class="form-horizontal" enctype="multipart/form-data">
    {{csrf_field()}}
        <div class="form-group">
            <div class="box box-default color-palette-box">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-tag"></i> Paket Premium Cuci Mobil</h3>
                    </div>
                        <div class="box-body">
